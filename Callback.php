<?php
// ================================
// Load Paystack keys from config.php on Render
// ================================
require_once __DIR__ . "/config.php";

// Validate secret key
if (!isset($paystack_secret_key) || empty($paystack_secret_key)) {
    die("Paystack secret key not set. Check config.php");
}
...
// Redirect user back to InfinityFree index.php with a success message
